...
public class MediaFile {
	...
	public static final int FILE_TYPE_3GPP = 2;
	...
	public static final int FILE_TYPE_3GPP1 = 23;
	...
	static {
		...
		addFileType("3GPP", FILE_TYPE_3GPP, "audio/3gpp");
	...
	public static boolean isAudioFileType(String path) {
		...
		if (null != type) {
			//System.out.println("fileType"+type.fileType);
